...
function Parser (opts) {
  ...
  parser.addArgument(
    ['--staging-secret'], {
      help: 'An AWS access key secret with permissions to access the staging DBR bucket. Defaults to the environment variable "STAGING_AWS_SECRET", then to "AWS_SECRET".',
